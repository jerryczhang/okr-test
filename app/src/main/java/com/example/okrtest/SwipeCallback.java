...
public class SwipeCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public SwipeCallback(RecyclerView.Adapter adapter, Context context) {
        ...
        leftBackground = new ColorDrawable(ContextCompat.getColor(context, R.color.TOMATO));
        rightBackground = new ColorDrawable(ContextCompat.getColor(context, R.color.KHAKI));
    }
